...
int main()
{
    ...
    TemperatureSensor sensor{&current_temp, std::ref(temperature_mtx)};
    TemperatureSimulator simulator{&current_temp, std::ref(temperature_mtx)};
    TemperatureRegulator regulator{&current_temp, MIN_TEMP_FOR_REGULATOR, MAX_TEMP_FOR_REGULATOR};
